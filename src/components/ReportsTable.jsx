  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex gap-2">
          ...
          <Button
            ...
            onClick={() => alert('Add report clicked')}
          >
            + Add a report
          </Button>
        </div>
      ...
      <div className="flex gap-2 mb-4 bg-white p-2 rounded">
        {['Tab 1', 'Tab 2', 'Tab 3'].map((tab) => (
          <button
            ...
            className={`rounded px-4 py-2 text-sm border transition-all ${
              activeTab === tab
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center w-full gap-2 max-w-lg">
          <input
            type="text"
            placeholder="Search"
            className="border bg-white focus:outline-none focus:border-orange-500 px-3 py-2 rounded w-full text-sm"
            value={searchTerm}
            onChange={(e) => setSearchTerm(e.target.value)}
          />
          <Button className="bg-white border text-gray-700 hover:bg-orange-50">Filters</Button>
        </div>
      </div>
