    ...
    return (
        <div className="min-h-screen p-6">
            <div className="mb-8">
                ...
                <p className="text-gray-500">Complete the daily report information</p>
            </div>
            ...
            <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input
                                ...
                                className=" bg-white w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-1 focus:ring-orange-500"
                        ...
                        <div>
                            <label className="block text-sm font-medium mb-2">Well</label>
                            <div className="relative">
                                <select
                                    name="concernedWell"
                                    value={formData.concernedWell}
                                    onChange={handleInputChange}
                                    className=" bg-white w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-1 focus:ring-orange-500 appearance-none"
                                >
                ...
                <div className="bg-white rounded-lg p-6 border shadow-md border-gray-200">
                    <h2 className="text-xl font-semibold mb-4">Daily Report Details</h2>
                    
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                            <label className="block text-sm mb-1">Current Phase</label>
                            <div className="relative ">
                                <select
                                    name="phase"
                        ...
                        <div>
                            <label className="block text-sm mb-1">Current Depth (ft)</label>
                            <input
                                type="number"
                                name="actualDepth"
                        ...
                        <div>
                            <label className="block text-sm mb-1">Lithology</label>
                            <div className="relative">
                                <select
                                    name="lithology"
                        ...
                        <div>
                            <label className="block text-sm mb-1">Daily Cost (DZD)</label>
                            <input
                                type="number"
                                name="dailyCost"
                ...
                <div className="bg-white rounded-lg p-6 border shadow-md border-gray-200">
                    <div className="flex justify-between items-center mb-2">
                        <h2 className="text-xl font-semibold">Operations Performed</h2>
                        <button
                            type="button"
                            onClick={addOperation}
                            className="text-white bg-orange-500 hover:bg-orange-600 transition-all duration-200 flex items-center px-4 py-2 rounded-md shadow-sm focus:ring-2 focus:ring-orange-500 focus:outline-none"
                        >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4  mt-4 mb-3">
                                    <div className="flex items-center space-x-3 col-span-1">
                                        <div className="flex-col items-center justify-between w-20">
                                            ...
                                            <button
                                                type="button"
                                                className={`flex h-6 w-12 mt-2 items-center rounded-full p-1 transition-colors duration-200 ease-in-out focus:outline-none ${operation.status ? 'bg-orangePtrm justify-end' : 'bg-gray-300 justify-start'}`}
                                    ...
                                    <div className="col-span-1">
                                        <label className="block text-sm mb-1">Operation Name</label>
                                        <div className="relative">
                                            <select
                                    ...
                                    <div className="col-span-1">
                                        <label className="block text-sm mb-1">Cost (DZD)</label>
                                        <div className="flex items-center">
                                            <input
                                                type="number"
                                                value={operation.cost}
                                                onChange={(e) => handleCostChange(operation.id, Number(e.target.value))}
                                                className="w-full  bg-white border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-1 focus:ring-orange-500"
                                                placeholder="0"
                                                style={{
                                ...
                                <div className="mt-4 bg-white p-3 rounded-lg border border-gray-100 shadow-sm">
                                    <div className="flex justify-between items-center mb-4">
                                        ...
                                        <button
                                            ...
                                            className="text-orange-500 hover:border-orangePtrm bg-white hover:text-orange-600 transition-all duration-200 flex items-center text-sm"
                                        >
                                        ...
                                        {operation.indicators.map((indicator) => (
                                            <div key={indicator.id} className="flex items-center space-x-2">
                                                <input
                                                    ...
                                                    className="flex-1  bg-white border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-1 focus:ring-orange-500"
                                                    placeholder="Indicator name ; indicator value"
                                                />
                                                <button
                                                    type="button"
                                                    onClick={() => removeIndicator(operation.id, indicator.id)}
                                                    className="text-gray-400  bg-white border-none  hover:text-red-500 transition-colors"
                                                >
                                                    <X size={18} />
                                                </button>
                                            </div>
                ...
                <div className="flex justify-center space-x-6 mt-8">
                    ...
                    <button
                        ...
                        className="px-10 py-2.5 bg-orange-500 text-white rounded-md hover:bg-orange-600 transition-all duration-200 shadow-sm focus:outline-none focus:ring-1 focus:ring-orange-600"
                    >
                        Save
                    </button>
                </div>
